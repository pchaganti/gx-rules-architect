"""xAI client helpers implemented on top of the OpenAI SDK."""
...
def get_client(base_url: str | None = None) -> OpenAI | Any:
    """
    Return a cached OpenAI client configured for the xAI endpoint.
    """
...
def execute_chat_completion(payload: dict[str, Any], base_url: str | None = None) -> Any:
    """Execute a Chat Completions request against the xAI endpoint."""
